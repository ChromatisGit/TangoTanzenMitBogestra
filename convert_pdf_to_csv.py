...
def convert_pdf_to_csv(pdf_path,pages):
    for i in range(1, pages + 1):
        table = camelot.read_pdf(pdf_path, pages=str(i), edge_tol=300, flavor='stream', columns=['163,178,194,209,224,240,255,271,286,302,317,333,348,364,379,395,410,426,441,457,472,488,503,518,534'], table_areas=[f'80,900,533,0'])
